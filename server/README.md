...
По умолчанию API слушает **`127.0.0.1:4000`** (только с этой машины). Для публикации в интернете см. **`../docs/deploy/DEPLOY.md`**. База: `server/data/app.db` (создаётся автоматически).
